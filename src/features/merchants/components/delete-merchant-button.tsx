...
import { deleteMerchant } from "@/app/d/merchants/action";

export function DeleteMerchantButton({ merchantId }: { merchantId: string }) {
      ...
      {confirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-[var(--card)] border border-[var(--border)] rounded-2xl p-6 w-full max-w-sm shadow-xl">
            <h2 className="text-lg font-bold text-[var(--text)] mb-2">{t("delete_merchant")}</h2>
