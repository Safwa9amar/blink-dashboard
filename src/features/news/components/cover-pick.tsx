...
// Cover picker: choose a preset cover or upload a custom one. The uploaded file
// is read into a data-URL (a mock stand-in for a real Storage/Blob upload).
  ...
  return (
    <div className="flex flex-wrap gap-2 mt-2">
      ...
      <button
        ...
        className="w-16 h-[42px] rounded-[9px] border-2 border-dashed border-border text-subtext flex flex-col items-center justify-center gap-0.5 hover:border-primary hover:text-primary transition-colors cursor-pointer"
        title={uploadLabel}
